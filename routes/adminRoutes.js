...
import { createAdmin, loginAdmin, createClient, getAllClients, getClientById, clientChangePassword, getAdminProfile, getTotalFunds, getTotalInterest, createPayout, getAllPayouts, getPayoutByStatus, getAllWithdrawalsRequest, toggleWithdrawalRequest, clientsTotalInvestment, addClientFund, deleteClient, editClient, updateBankDetails } from '../controllers/AdminController.js';
